let GameManager = {
  ...
  resetPlayer: function(classType){
    ...
    getInterface.innerHTML = '<img src="img/arena-player/' +
  ...
  setFight: function () {
    ...
    // Create enemy!
    let enemy00 = new Enemy("Akuma", 200, 0, 50, 100, 100);
    let enemy01 = new Enemy("Byson", 200, 0, 50, 80, 100);
    let enemy02 = new Enemy("Kazuya", 100, 0, 80, 50, 100);
    ...
    getEnemy.innerHTML = '<img src="img/arena-enemies/' +
    enemy.enemyType.toLowerCase() + '.jpg" alt= "' + enemy.enemyType + '"class ="img-avatar"><div><h3>' + enemy.enemyType + '</h3><p class="health-enemy">Health: ' + enemy.health +
        '</p><p>Mana: ' + enemy.mana +
